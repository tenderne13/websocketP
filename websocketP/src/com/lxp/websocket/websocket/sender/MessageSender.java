package com.lxp.websocket.websocket.sender;
...
import com.lxp.websocket.po.message.ToClientTextMessage;
import com.lxp.websocket.po.message.ToServerMessageMine;
import com.lxp.websocket.po.message.ToServerTextMessage;
import com.lxp.websocket.po.result.ToClientMessageResult;
import com.lxp.websocket.po.result.ToClientMessageType;
import com.lxp.websocket.websocket.LayIMChatType;
...
public class MessageSender {
    ...
    private  void sendMessage(Integer userId,String message){
        SocketUser user = UserManager.getInstance().getUser(userId);
        if (user.isExist()) {

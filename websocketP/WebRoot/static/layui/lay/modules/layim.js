...
'upload'], function (i) {
    ...
    c.prototype.on = function (i, a) {
        return 'function' == typeof a && (r[i] ? r[i].push(a)  : r[i] = [
            a
        ]),
        this
    },
    ...
    var u = function (i) {
        ...
        [
            ...
            '<li layim-event="chat" data-type="' + i.type + '" data-index="{{ ' + (i.index || 'i') + ' }}" class="layim-' + ('history' === i.type ? '{{i}}' : i.type + '{{data.id}}') + ' {{ data.status === "offline" ? "layim-list-gray" : "" }}"><img src="{{ data.avatar }}"><span>{{ data.username||data.groupname||data.name||"佚名" }}</span><p>{{ data.remark||data.sign||"" }}</p><span class="layim-msg-status">new</span></li>',
            '{{# }); if(length === 0){ }}',
    ...
    S = function (i, a, n) {
        ...
        e.ajax({
            ...
            success: function (i) {
                0 == i.code ? a && a(i.data || {
                })  : t.msg(i.msg || (n || 'Error') + ': LAYIM_NOT_GET_DATA', {
                    time: 5000
                })
            },
            error: function (i, a) {
    ...
    K = function (i) {
        ...
        l = a.index();
        if (i.timestamp = i.timestamp || (new Date).getTime(), i.fromid == j.mine.id && (i.mine = false), i.system || B(i), G = JSON.parse(JSON.stringify(i)), j.base.voice && F(), !w && i.content || l === - 1) {
            if (j.message[i.type + i.id]) j.message[i.type + i.id].push(i);
             else if (j.message[i.type + i.id] = [
                i
            ], 'friend' === i.type) {
                var s;
    ...
    U = function (i) {
        ...
        if (j[i.type]) if ('friend' === i.type) layui.each(j.friend, function (n, l) {
            ...
            ], e[j.friend[n].list.length] = i, i.groupIndex = n, j.friend[n].list.push(i), !0)
        });
         else if ('group' === i.type) {
    ...
    Z = function () {
        ...
        a.scrollTop(a[0].scrollHeight + 1000),
    ...
    ai = function (i, a) {
        ...
        t = i.value;
        i.focus(),
        document.selection ? (e = document.selection.createRange(), document.selection.empty(), e.text = a)  : (e = [
            t.substring(0, i.selectionStart),
            a,
            t.substr(i.selectionEnd)
        ], i.focus(), i.value = e.join(''))
    },
    ei = 'layui-anim-upbit',
    ti = {
        status: function (i, a) {
        ...
        search: function (i) {
            ...
            n = function (i) {
                ...
                if ('' === a) ti.tab(0 | ti.tab.index);
                    ...
                    ], o = '', d = 0; d < l.length; d++) for (var r = 0; r < (l[d].list || [
                    ]).length; r++) l[d].list[r].username.indexOf(a) !== - 1 && (l[d].list[r].type = 'friend', l[d].list[r].index = d, l[d].list[r].list = r, n.push(l[d].list[r]));
        ...
        chat: function (i) {
            ...
            'friend' === e ? l = j[e][t].list[n] : 'group' === e ? l = j[e][n] : 'history' === e && (l = (a.history || {
            }) [t] || {
            }),
            ...
            i.data('down') ? l()  : (n.html('&#xe619;'), i.data('down', !0), ti.groupMembers.index = t.tips('<ul class="layim-members-list"></ul>', i, {
                ...
                success: function (a) {
                    ...
                    S(t, function (a) {
                        ...
                        s.html(o),
                        i.find('.layim-chat-members').html(a.members || (a.list || [
                        ]).length + '人'),
        ...
        media: function (i) {
            ...
            t.prompt({
                ...
                shade: !1,
                offset: [
                    i.offset().top - e(window).scrollTop() - 158 + 'px',
                    i.offset().left + 'px'
                ]
            }, function (i, e) {
                ai(l.textarea[0], a + '[' + i + ']'),
